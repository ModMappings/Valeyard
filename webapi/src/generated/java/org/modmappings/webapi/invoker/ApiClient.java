...
import org.modmappings.webapi.invoker.auth.Authentication;
import org.modmappings.webapi.invoker.auth.HttpBasicAuth;
import org.modmappings.webapi.invoker.auth.HttpBearerAuth;
import org.modmappings.webapi.invoker.auth.ApiKeyAuth;
import org.modmappings.webapi.invoker.auth.OAuth;
import org.modmappings.webapi.invoker.auth.RetryingOAuth;
import org.modmappings.webapi.invoker.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("ModMappings auth", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "http://localhost:8081/auth/realms/ModMappings/protocol/openid-connect/token";
